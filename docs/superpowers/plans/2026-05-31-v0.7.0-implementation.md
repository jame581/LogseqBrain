...
- Run `git grep -n "brain-config.json"` — expect matches ONLY in `.gitignore` (legacy, kept for back-compat) and historical specs/plans (`2026-05-01-*`). No live skill or current doc should present it as the source of truth.
